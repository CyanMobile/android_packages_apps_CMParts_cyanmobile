...
public class LockscreenWidgetsActivity extends PreferenceActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCusText = (EditTextPreference) prefSet.findPreference(PREF_LABEL_TEXT_CUSTOM);
        if (mCusText != null) {
            EditText customEditText = mCusText.getEditText();

            if (customEditText != null) {
                InputFilter lengthFilter = new InputFilter.LengthFilter(20);
                customEditText.setFilters(new InputFilter[]{lengthFilter});
                customEditText.setSingleLine(true);
            }
        }
        String labelTextCustom = Settings.System.getString(getContentResolver(),
                Settings.System.CUSTOM_TEXT_STRING);

        if (labelTextCustom == null) {
            labelTextCustom = "CyanMobileX";
            Settings.System.putString(getContentResolver(),
                    Settings.System.CUSTOM_TEXT_STRING,
		    labelTextCustom);
	}
        mCusText.setText(labelTextCustom);
        mCusText.setOnPreferenceChangeListener(this);

        mLockscreenCarrierLabel = (ListPreference) prefSet
                .findPreference(PREF_LOCKSCREEN_CARRIER_LABEL);
        mLockscreenCarrierLabelCustom = (EditTextPreference) prefSet
                .findPreference(PREF_LOCKSCREEN_CARRIER_LABEL_CUSTOM);

        if (mLockscreenCarrierLabelCustom != null) {
            EditText carrierEditText = mLockscreenCarrierLabelCustom.getEditText();
        ...
        int lockscreenCarrierLabel = Settings.System.getInt(getContentResolver(),
                Settings.System.CARRIER_LABEL_LOCKSCREEN_TYPE, 0);
        String lockscreenCarrierLabelCustom = Settings.System.getString(getContentResolver(),
                Settings.System.CARRIER_LABEL_LOCKSCREEN_CUSTOM_STRING);

        if (lockscreenCarrierLabelCustom == null) {
            lockscreenCarrierLabelCustom = "CyanMobileX";
            Settings.System.putString(getContentResolver(),
                    Settings.System.CARRIER_LABEL_LOCKSCREEN_CUSTOM_STRING,
		    lockscreenCarrierLabelCustom);
	}

        mLockscreenCarrierLabel.setValue(String.valueOf(lockscreenCarrierLabel));
        mLockscreenCarrierLabel.setOnPreferenceChangeListener(this);

        mLockscreenCarrierLabelCustom.setText(lockscreenCarrierLabelCustom);
        mLockscreenCarrierLabelCustom.setOnPreferenceChangeListener(this);
        mLockscreenCarrierLabelCustom.setEnabled(
                lockscreenCarrierLabel == 3);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mLockscreenMusicHeadsetPref) {
            ...
            Settings.System.putString(getContentResolver(),
                    ...
                    labelTextCustom);
            return true;
        } else if (preference == mLockscreenCarrierLabel) {
            int carrierLabelType = Integer.valueOf((String) newValue);
            mLockscreenCarrierLabelCustom.setEnabled(carrierLabelType == 3);
            Settings.System.putInt(getContentResolver(), Settings.System.CARRIER_LABEL_LOCKSCREEN_TYPE,
                    carrierLabelType);
            return true;
        } else if (preference == mLockscreenCarrierLabelCustom) {
