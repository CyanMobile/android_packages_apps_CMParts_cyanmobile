...
public class LongPressHomeActivity extends PreferenceActivity
    ...
    private static final String USE_TASKSWITCHER_PREF = "pref_use_taskswitcher";
    ...
    private CheckBoxPreference mUseTaskSwitcherPref;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUseTaskSwitcherPref = (CheckBoxPreference) prefSet.findPreference(USE_TASKSWITCHER_PREF);
    ...
    public void onResume() {
        ...
        mUseTaskSwitcherPref.setChecked((Settings.System.getInt(getContentResolver(), Settings.System.USE_TASKSWITCHER, 1) == 1) && 
                                        (Settings.System.getInt(getContentResolver(), Settings.System.USE_CUSTOM_APP, 0) != 1));
        mUseCustomAppPref.setChecked((Settings.System.getInt(getContentResolver(), Settings.System.USE_TASKSWITCHER, 1) != 1) && 
                                        (Settings.System.getInt(getContentResolver(), Settings.System.USE_CUSTOM_APP, 0) == 1));
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mUseQuickHomePref) {
        ...
        } else if (preference == mUseTaskSwitcherPref) {
            Settings.System.putInt(getContentResolver(), Settings.System.USE_TASKSWITCHER, mUseTaskSwitcherPref.isChecked() ? 1 : 0);
            if (mUseTaskSwitcherPref.isChecked()){
            ...
            if (mUseCustomAppPref.isChecked()){
                ...
                mUseTaskSwitcherPref.setChecked(false);
                Settings.System.putInt(getContentResolver(), Settings.System.RECENT_APPS_SHOW_TITLE, 0);
                Settings.System.putInt(getContentResolver(), Settings.System.USE_TASKSWITCHER, 0);
            }
        }
