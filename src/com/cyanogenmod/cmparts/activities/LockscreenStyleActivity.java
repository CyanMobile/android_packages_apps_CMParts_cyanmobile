...
import com.cyanogenmod.cmparts.activities.LSColorPickerDialog.OnColorChangedListener;
...
public class LockscreenStyleActivity extends PreferenceActivity implements
    ...
    private Preference mStatusBarLockscreenColor;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLockscreenStyle = LockscreenStyle.getStyleById(
                ...
                Settings.System.LOCKSCREEN_STYLE_PREF, LockscreenStyle.getIdByStyle(LockscreenStyle.Honeycomb)));
        ...
        mRinglockStyle = RinglockStyle.getStyleById(
                Settings.System.getInt(getContentResolver(),
                Settings.System.RINGLOCK_STYLE_PREF, RinglockStyle.getIdByStyle(RinglockStyle.Holo)));
    ...
    private void updateCustomAppSummary() {
        if (mLockscreenStyle == LockscreenStyle.Ring || mLockscreenStyle == LockscreenStyle.Honeycomb || mLockscreenStyle == LockscreenStyle.Sense) {
    ...
    LSColorPickerDialog.OnColorChangedListener mLockscreenColorListener =
        new LSColorPickerDialog.OnColorChangedListener() {
            public void LScolorChanged(int LScolor) {
                Settings.System.putInt(getContentResolver(), Settings.System.STATUS_BAR_LOCKSCREENCOLOR, LScolor);
                mStatusBarLockscreenColor.setSummary(Integer.toHexString(LScolor));
            }
