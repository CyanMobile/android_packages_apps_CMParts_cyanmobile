...
public class PowerWidgetUtil {
    ...
    public static final String BUTTON_USBAP = "toggleUsbAp";
    ...
    static {
        ...
        BUTTONS.put(BUTTON_USBAP, new PowerWidgetUtil.ButtonInfo(
                BUTTON_USBAP, R.string.title_toggle_usbap, "com.android.systemui:drawable/stat_usb_tether_icon_on"));
    ...
    public static String getCurrentButtons(Context context) {
        ...
        if (buttons == null) {
            ...
            if (addPowerWidget) {
                buttons += BUTTON_DELIMITER + BUTTON_AIRPLANE;
                buttons += BUTTON_DELIMITER + BUTTON_AUTOROTATE;
                buttons += BUTTON_DELIMITER + BUTTON_BRIGHTNESS;
                buttons += BUTTON_DELIMITER + BUTTON_LOCKSCREEN;
                buttons += BUTTON_DELIMITER + BUTTON_MOBILEDATA;
                buttons += BUTTON_DELIMITER + BUTTON_NETWORKMODE;
                buttons += BUTTON_DELIMITER + BUTTON_SCREENTIMEOUT;
                buttons += BUTTON_DELIMITER + BUTTON_SLEEP;
                buttons += BUTTON_DELIMITER + BUTTON_SCREENSHOT;
                buttons += BUTTON_DELIMITER + BUTTON_SYNC;
                buttons += BUTTON_DELIMITER + BUTTON_WIFIAP;
                buttons += BUTTON_DELIMITER + BUTTON_USBAP;
                buttons += BUTTON_DELIMITER + BUTTON_MEDIA_PLAY_PAUSE;
            }
